...
class DuenoHomeScreen extends StatefulWidget {
  const DuenoHomeScreen({super.key});

  @override
  State<DuenoHomeScreen> createState() => _DuenoHomeScreenState();
}

class _DuenoHomeScreenState extends State<DuenoHomeScreen> {
  ...
  void _showAnalytics() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Analíticas del Restaurante'),
          content: const Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ListTile(
                leading: Icon(Icons.restaurant_menu),
                title: Text('Total de platos'),
                subtitle: Text('25 platos'),
              ),
              ListTile(
                leading: Icon(Icons.check_circle),
                title: Text('Platos disponibles'),
                subtitle: Text('20 platos'),
              ),
              ListTile(
                leading: Icon(Icons.cancel),
                title: Text('Platos no disponibles'),
                subtitle: Text('5 platos'),
              ),
              ListTile(
                leading: Icon(Icons.attach_money),
                title: Text('Ventas del día'),
                subtitle: Text('\$1,250.00'),
              ),
            ],
          ),
          actions: [
